...
The phrase "distraction by design" is precise rather than rhetorical. These systems are not badly built; they are extremely well built, for a purpose that differs from the user's, and the gap between those two purposes is where the time goes.
